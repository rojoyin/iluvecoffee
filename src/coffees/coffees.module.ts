...
@Module({
  ...
  imports: [TypeOrmModule.forFeature([Coffee])], // list of modules that THIS module requires, any exported providers of the imported modules will be available within this module
})
