...
@Module({
  ...
  imports: [
    ...
    ConfigModule.forFeature(coffeesConfig), // register config modules close to their domains
  ], // list of modules that THIS module requires, any exported providers of the imported modules will be available within this module
})
